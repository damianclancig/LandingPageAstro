...
export const projects: Project[] = [
  {
    ...
    seniorInsight:
      'Prioricé la mantenibilidad del código creando una arquitectura de componentes modulares. Esto permite escalar el sistema para añadir nuevas features, como tele-consultas, sin afectar el core de la libreta sanitaria digital.',
  ...
  },
  {
    ...
    challenge:
      'Las aplicaciones financieras comunes fallan al no ofrecer previsibilidad a largo plazo sobre gastos recurrentes y pagos fraccionados. Se requería un dashboard de alta fidelidad visual que garantizara la consistencia de los registros en tiempo real.',
    solution: [
    ...
    seniorInsight:
      'El verdadero valor de FinanClan reside en su motor de proyección. Diseñé la lógica de datos para que el sistema transforme registros estáticos en una herramienta predictiva para la toma de decisiones financieras.',
  ...
  },
  {
    ...
    challenge:
      'Eliminar la fricción en la toma de asistencia y el seguimiento del progreso académico en entornos educativos, manejando un alto volumen de transacciones concurrentes.',
    solution: [
  ...
  },
  {
    ...
    challenge:
      'Unificar dos modelos de negocio divergentes (venta de productos físicos como suculentas/kokedamas y reserva de servicios por hora como guardería de plantas) en una sola experiencia de compra fluida y coherente.',
    solution: [
    ...
    seniorInsight:
      "Actué como Consultor Tecnológico estructurando la plataforma para vender 'servicios de valor' además de productos. Esta digitalización logística permitió al negocio aumentar significativamente su ticket promedio.",
  ...
  },
  {
    ...
    status: 'Producción / Activo',
    challenge:
      'Trasladar la identidad de terapias holísticas (Reiki, masajes, yoga) a interfaces digitales minimalistas sin sacrificar la velocidad de carga ni la capacidad de captación de leads.',
    solution: [
  ...
  },
  {
    ...
    status: 'Producción / Activo',
    challenge:
      'Crear una utilidad de consulta meteorológica extremadamente rápida y limpia, libre del ruido visual de las aplicaciones climáticas tradicionales.',
    solution: [
